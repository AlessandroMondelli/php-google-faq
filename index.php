...
<html>
    ...
    <body>
        ...
        <main>
            <div class="faq-sez container">
                <?php
                    for ($i = 1; $i <= 4; $i++) { //ciclo i per 4 volte
                        foreach ($faqs as $value) { //scorro array e contenuti
                ?>
                            <div class="faq">
                                <? //Stampo domande e risposte concatenando il contatore?>
                                <h2><?php echo $value['faq_' . $i]['domanda'] ?></h2>
                                <p><?php echo $value['faq_'. $i]['risposta'] ?></p>
                            </div>
                <?php   }
                    }
                ?>
